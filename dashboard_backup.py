...
class WatchXDashboard:
    ...
    def show_vehicle_details(self, event=None):
        ...
        # ----------------------------------------------------
        # FIND ALL RECORDS BELONGING TO THIS VEHICLE ID
        # ----------------------------------------------------
        vehicle_history = []
        ...
        # Sort history by detection time
        def get_time(row):
            try:
        ...
        if vehicle_history:
            first_detection = get_time(vehicle_history[0])
            last_detection = get_time(vehicle_history[-1])
        else:
            first_detection = 0.0
            last_detection = 0.0
        ...
        details.geometry("1050x800")
        details.minsize(900, 700)
        ...
        # HISTORY ROWS
        # ----------------------------------------------------
        for index, row in enumerate(vehicle_history):
