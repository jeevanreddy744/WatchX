...
# ============================================================
# The OCR engine and dashboard must read/write the same data.
# The desktop launcher can override this with WATCHX_DATA_DIR.
...
CSV_FILE = DATA_DIR / "watchx_records.csv"
...
class WatchXDashboard:
    ...
    def show_vehicle_details(self, event=None):
        ...
        # ----------------------------------------------------
        # The investigation page contains several sections. On smaller
        # laptop screens, Detection History can otherwise fall below
        # the visible area.
        content_container = tk.Frame(details, bg=BG)
        ...
        main = tk.Frame(content_canvas, bg=BG)
        ...
        content_canvas.bind("<Configure>", resize_scroll_content)
